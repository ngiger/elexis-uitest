...
# -DuseBranch=f11106
export cmd="mvn -V clean install -f $PWD/h2/pom.xml -Dlanguage=fr --settings=$PWD/h2/settings.xml -DautExplicit=/home/niklaus/work -Dsuite2run=SmokeTestSetup"
export cmd="mvn -V clean install -f $PWD/h2/pom.xml -Dlanguage=fr --settings=$PWD/h2/settings.xml "
