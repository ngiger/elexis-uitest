...
# -DuseBranch=f11106
export cmd="mvn -V --batch-mode clean install -f $PWD/h2/pom.xml -Dlanguage=it --settings=$PWD/h2/settings.xml -DautExplicit=/home/niklaus/work -Dsuite2run=SmokeTestSetup"
export cmd="mvn -V --batch-mode clean install -f $PWD/h2/pom.xml -Dlanguage=it --settings=$PWD/h2/settings.xml "
